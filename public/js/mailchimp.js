...
(function(e, t) {
    ...
    function document.querySelector(e, t, n, r, i) {
    ...
    var X, U, V = e.document,
        ...
        ut = /[+-]?(?:d*.|)d+(?:[eE][+-]?d+|)/.source,
        lt = /S+/g,
        ct = /^[suFEFFxA0]+|[suFEFFxA0]+$/g,
        ft = /^(?:(<[wW]+>)[^>]*|#([w-]*))$/,
        pt = /^<(w+)s*/?>(?:</1>|)$/,
        dt = /^[],:{}s]*$/,
        ht = /(?:^|:|,)(?:s*[)+/g,
        gt = /\(?:["\/bfnrt]|u[da-fA-F]{4})/g,
        mt = /"[^"\rn]*"|true|false|null|-?(?:d+.|)d+(?:[eE][+-]?d+|)/g,
        yt = /^-ms-/,
        vt = /-([da-z])/gi,
        bt = function(e, t) {
    ...
    st.fn = st.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if (!e) return this;
            if ("string" == typeof e) {
                if (i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ft.exec(e), !i || !i[1] && n) return !n || n.jquery ? (n || r).querySelector(e) : this.constructor(n).querySelector(e);
                if (i[1]) {
                ...
                if (o = V.getElementById(i[2]), o && o.parentNode) {
                    if (o.id !== i[2]) return r.querySelector(e);
        ...
        ready: function(e) {
            if (e === !0 ? !--st.readyWait : !st.isReady) {
                ...
                st.isReady = !0, e !== !0 && --st.readyWait > 0 || (U.resolveWith(V, [st]), st.fn.trigger && st(V).trigger("ready").removeEventListener("ready"))
            }
        },
        ...
        trim: at && !at.call("ufeffu00a0") ? function(e) {
    ...
    st.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (st.isFunction(e)) return this.each(function(t) {
                st(this).classList.add(e.call(this, t, this.className))
            });
            if (u)
        ...
        removeClass: function(e) {
            ...
            if (st.isFunction(e)) return this.each(function(t) {
                st(this).classList.remove(e.call(this, t, this.className))
            });
            if (u)
                for (t = (e || "").match(lt) || []; s > a; a++)
                    if (n = this[a], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Et, " ") : "")) {
        ...
        toggleClass: function(e, t) {
            ...
            return st.isFunction(e) ? this.each(function(n) {
                st(this).classList.toggle(e.call(this, n, this.className, t), t)
            }) : this.each(function() {
                if ("string" === n)
                    for (var i, o = 0, a = st(this), s = t, u = e.match(lt) || []; i = u[o++];) s = r ? s : !a.classList.contains(i), a[s ? "addClass" : "removeClass"](i);
        ...
        val: function(e) {
            var n, r, i, o = this[0]; {
                if (arguments.length) return i = st.isFunction(e), this.each(function(r) {
                    var o, a = st(this);
                    1 === this.nodeType && (o = i ? e.call(this, r, a.value) : e, null == o ? o = "" : "number" == typeof o ? o += "" : st.isArray(o) && (o = st.map(o, function(e) {
                        return null == e ? "" : e + ""
                ...
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, u = 0 > i ? s : o ? i : 0; s > u; u++)
                        if (n = r[u], !(!n.selected && u !== i || (st.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && st.nodeName(n.parentNode, "optgroup"))) {
                            if (t = st(n).value, o) return t;
                            a.push(t)
                        } return a
                },
                set: function(e, t) {
                    var n = st.makeArray(t);
                    return st(e).querySelector("option").each(function() {
                        this.selected = st.inArray(st(this).value, n) >= 0
        ...
        st.valHooks[this] = st.extend(st.valHooks[this], {
            set: function(e, n) {
                return st.isArray(n) ? e.checked = st.inArray(st(e).value, n) >= 0 : t
            }
        })
    });
    ...
    st.event = {
                ...
                if (u && l.nodeType && (!e.button || "click" !== e.type))
                    for (; l != this; l = l.parentNode || this)
                        if (l.disabled !== !0 || "click" !== e.type) {
                            for (i = [], r = 0; u > r; r++) a = n[r], o = a.selector + " ", i[o] === t && (i[o] = a.needsContext ? st(o, this).index(l) >= 0 : st.querySelector(o, this, null, [l]).length), i[o] && i.push(a);
                            i.length && s.push({
                                elem: l,
                                handlers: i
                            })
            ...
            on: function(e, n, r, i, o) {
                ...
                if ("object" == typeof e) {
                    ...
                    for (s in e) this.addEventListener(s, n, r, e[s], o);
                    return this
                }
                if (null == r && null == i ? (i = n, r = n = t) : null == i && ("string" == typeof n ? (i = r, r = t) : (i = r, r = n, n = t)), i === !1) i = l;
                else if (!i) return this;
                return 1 === o && (a = i, i = function(e) {
                    return st().removeEventListener(e), a.apply(this, arguments)
                }, i.guid = a.guid || (a.guid = st.guid++)), this.each(function() {
                    st.event.add(this, e, i, r, n)
                })
            },
            one: function(e, t, n, r) {
                return this.addEventListener(e, t, n, r, 1)
            },
            off: function(e, n, r) {
                var i, o;
                if (e && e.preventDefault && e.handleObj) return i = e.handleObj, st(e.delegateTarget).removeEventListener(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler), this;
                if ("object" == typeof e) {
                    for (o in e) this.removeEventListener(o, n, e[o]);
                    return this
                }
            ...
            unbind: function(e, t) {
                return this.removeEventListener(e, null, t)
            },
            delegate: function(e, t, n, r) {
                return this.addEventListener(t, e, n, r)
            },
            undelegate: function(e, t, n) {
                return 1 === arguments.length ? this.removeEventListener(e, "**") : this.removeEventListener(t, e || "**", n)
            },
            ...
            st.fn[t] = function(e, n) {
                return arguments.length > 0 ? this.addEventListener(t, null, e, n) : this.trigger(t)
        ...
        function(e, t) {
            ...
            var w, N, C, k, E, S, A, j, D, L, H, M, q, _, F, O, B, P = "sizzle" + -new Date,
                ...
                yt = /^hd$/i,
                vt = /'|\/g,
                bt = /=[x20trnf]*([^'"]]*)[x20trnf]*]/g,
                xt = /\([da-fA-F]{1,6}[x20trnf]?|.)/g,
                Tt = function(e, t) {
                    var n = "0x" + t - 65536;
    ...
    st.fn.extend({
        find: function(e) {
            ...
            for (n = [], t = 0; this.length > t; t++) st.querySelector(e, this[t], n);
    ...
    on.optgroup = on.option, on.tbody = on.tfoot = on.colgroup = on.caption = on.thead, on.th = on.td, st.fn.extend({
        text: function(e) {
            return st.access(this, function(e) {
                return e === t ? st.text(this) : this.empty().insertAdjacentHTML("beforeend",(this[0] && this[0].ownerDocument || V).createTextNode(e))
        ...
        wrapInner: function(e) {
            return st.isFunction(e) ? this.each(function(t) {
                ...
                var t = st(this),
                    n = t.contents();
                n.length ? n.wrapAll(e) : t.insertAdjacentHTML("beforeend",e)
            })
        },
        wrap: function(e) {
        ...
        html: function(e) {
            return st.access(this, function(e) {
                ...
                n && this.empty().insertAdjacentHTML("beforeend",e)
            }, null, e, arguments.length)
        },
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return null == n ? null : st.isArray(n) ? st.map(n, function(e) {
                    return {
                        name: t.name,
                        value: e.replace(En, "rn")
                    }
                }) : {
                    name: t.name,
                    value: n.replace(En, "rn")
                }
            }).get()
        }
    ...
    jn = Pn.exec(Dn.toLowerCase()) || [], st.fn.load = function(e, n, r) {
        ...
        return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)), st.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (o = "POST"), s.length > 0 && st.ajax({
            ...
            a = arguments, s.html(i ? st("<div>").insertAdjacentHTML("beforeend",st.parseHTML(e)).querySelector(i) : e)
...
! function(e) {
    ...
    e.fn.attr2 = function() {
        ...
        function o(a) {
            for (var n = new FormData, i = 0; i < a.length; i++) n.insertAdjacentHTML("beforeend",a[i].name, a[i].value);
            if (t.extraData) {
                var o = r(t.extraData);
                for (i = 0; i < o.length; i++) o[i] && n.insertAdjacentHTML("beforeend",o[i][0], o[i][1])
            }
            t.data = null;
        ...
        return n.delegation ? (e(document).removeEventListener("submit.form-plugin", this.selector, t).removeEventListener("click.form-plugin", this.selector, r).addEventListener("submit.form-plugin", this.selector, n, t).addEventListener("click.form-plugin", this.selector, n, r), this) : this.ajaxFormUnbind().bind("submit.form-plugin", n, t).bind("click.form-plugin", n, r)
        ...
        return this.each(function() {
            ...
            r.test(a) || "textarea" == n ? this.value = "" : "checkbox" == a || "radio" == a ? this.checked = !1 : "select" == n ? this.selectedIndex = -1 : "file" == a ? /MSIE/.test(navigator.userAgent) ? e(this).replaceWith(e(this).clone(!0)) : e(this).value : t && (t === !0 && /hidden/.test(a) || "string" == typeof t && e(this).is(t)) && (this.value = "")
        })
        ...
        return void 0 === t && (t = !0), this.each(function() {
            ...
            if ("checkbox" == r || "radio" == r) this.checked = t;
                ...
                t && a[0] && "select-one" == a[0].type && a.querySelector("option").selected(!1), this.selected = t
            }
        })
    ...
    a.extend(a.fn, {
        validate: function(b) {
            ...
            return c ? c : (this.attr("novalidate", "novalidate"), c = new a.validator(b, this[0]), a.data(this[0], "validator", c), c.settings.onsubmit && (this.validateDelegate(":submit", "click", function(b) {
                c.settings.submitHandler && (c.submitButton = b.target), a(b.target).classList.contains("cancel") && (c.cancelSubmit = !0), void 0 !== a(b.target).attr("formnovalidate") && (c.cancelSubmit = !0)
            }), this.submit(function(b) {
                function d() {
                    var d;
                    return c.settings.submitHandler ? (c.submitButton && (d = a("<input type='hidden'/>").attr("name", c.submitButton.name).val(a(c.submitButton).value).appendTo(c.currentForm)), c.settings.submitHandler.call(c, c.currentForm, b), c.submitButton && d.remove(), !1) : !0
                }
        ...
        defaults: {
            ...
            highlight: function(b, c, d) {
                "radio" === b.type ? this.findByName(b.name).classList.add(c).classList.remove(d) : a(b).classList.add(c).classList.remove(d)
            },
            unhighlight: function(b, c, d) {
                "radio" === b.type ? this.findByName(b.name).classList.remove(c).classList.add(d) : a(b).classList.remove(c).classList.add(d)
            }
        },
        ...
        prototype: {
            init: function() {
                ...
                }), a(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", b).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", b), this.settings.invalidHandler && a(this.currentForm).bind("invalid-form.validate", this.settings.invalidHandler), a(this.currentForm).querySelector("[required], [data-rule-required], .required").attr("aria-required", "true")
            },
            form: function() {
            ...
            resetForm: function() {
                a.fn.resetForm && a(this.currentForm).resetForm(), this.submitted = {}, this.lastElement = null, this.prepareForm(), this.hideErrors(), this.elements().classList.remove(this.settings.errorClass).removeData("previousValue").removeAttr("aria-invalid")
            },
            ...
            elements: function() {
                var b = this,
                    c = {};
                return a(this.currentForm).querySelector("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(this.settings.ignore).filter(function() {
            ...
            elementValue: function(b) {
                var c, d = a(b),
                    e = d.attr("type");
                return "radio" === e || "checkbox" === e ? a("input[name='" + d.attr("name") + "']:checked").value : (c = d.value, "string" == typeof c ? c.replace(/r/g, "") : c)
            },
            check: function(b) {
            ...
            showLabel: function(b, c) {
                ...
                d.length ? (d.classList.remove(this.settings.validClass).classList.add(this.settings.errorClass), d.html(c)) : (d = a("<" + this.settings.errorElement + ">").attr("for", this.idOrName(b)).classList.add(this.settings.errorClass).html(c || ""), this.settings.wrapper && (d = d.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.insertAdjacentHTML("beforeend",d).length || (this.settings.errorPlacement ? this.settings.errorPlacement(d, a(b)) : d.insertAfter(b))), !c && this.settings.success && (d.text(""), "string" == typeof this.settings.success ? d.classList.add(this.settings.success) : this.settings.success(d, b)), this.toShow = this.toShow.add(d)
            },
            ...
            findByName: function(b) {
                return a(this.currentForm).querySelector("[name='" + b + "']")
            },
        ...
        methods: {
            ...
            url: function(a, b) {
                return this.optional(b) || /^(https?|s?ftp)://(((([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(%[da-f]{2})|[!$&'()*+,;=]|:)*@)?(((d|[1-9]d|1dd|2[0-4]d|25[0-5]).(d|[1-9]d|1dd|2[0-4]d|25[0-5]).(d|[1-9]d|1dd|2[0-4]d|25[0-5]).(d|[1-9]d|1dd|2[0-4]d|25[0-5]))|((([a-z]|d|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(([a-z]|d|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])*([a-z]|d|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF]))).)+(([a-z]|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(([a-z]|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])*([a-z]|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF]))).?)(:d*)?)(/((([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(%[da-f]{2})|[!$&'()*+,;=]|:|@)+(/(([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(%[da-f]{2})|[!$&'()*+,;=]|:|@)*)*)?)?(?((([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(%[da-f]{2})|[!$&'()*+,;=]|:|@)|[uE000-uF8FF]|/|?)*)?(#((([a-z]|d|-|.|_|~|[u00A0-uD7FFuF900-uFDCFuFDF0-uFFEF])|(%[da-f]{2})|[!$&'()*+,;=]|:|@)|/|?)*)?$/i.test(a)
            },
            date: function(a, b) {
...
(function($) {
    ...
    $.validator.addMethod("mc_birthday", function(date, element, grouping_class) {
        var isValid = false;
        var $fields = document.querySelector('input:not(:hidden)', document.querySelector(element).closest(grouping_class));
        if ($fields.filter(':filled').length == 0 && this.optional(element)) {
            isValid = true; // None have been filled out, so no error	
        } else {
            var dateArray = new Array();
            dateArray['month'] = $fields.filter("input[name*='[month]']").value;
            dateArray['day'] = $fields.filter("input[name*='[day]']").value;
    ...
    $.validator.addMethod("mc_date", function(date, element, grouping_class) {
        ...
        if ($fields.filter(':filled').length == 0 && this.optional(element)) {
            ...
            dateArray['month'] = $fields.filter("input[name*='[month]']").value;
            dateArray['day'] = $fields.filter("input[name*='[day]']").value;
            dateArray['year'] = $fields.filter("input[name*='[year]']").value;
    ...
    $.validator.addMethod("mc_phone", function(phone_number, element, grouping_class) {
        var isValid = false;
        var $fields = document.querySelector('input:filled:not(:hidden)', document.querySelector(element).closest(grouping_class));
        if ($fields.length == 0 && this.optional(element)) {
            isValid = true; // None have been filled out, so no error	
        } else {
            phone_number = $fields.eq(0).value + $fields.eq(1).value + $fields.eq(2).value;
    ...
    $.validator.addMethod("skip_or_complete_group", function(value, element, grouping_class) {
        ...
        if (!document.querySelector(element).data("being_validated")) {
    ...
    $.validator.addMethod("skip_or_fill_minimum", function(value, element, options) {
        var $fields = document.querySelector(options[1], element.form),
            $fieldsFirst = $fields.eq(0),
            validator = $fieldsFirst.data("valid_skip") ? $fieldsFirst.data("valid_skip") : $.extend({}, this),
            numberFilled = $fields.filter(function() {
                return validator.elementValue(this);
...
(function($) {
    ...
    window.mc = {
        openPopup: function() {
            document.querySelector('#mc_embed_signup a.mc_embed_close').show();
            setTimeout(function() {
                document.querySelector('#mc_embed_signup').fadeIn();
            }, mc.delayPopup);
        },
        closePopup: function() {
            document.querySelector('#mc_embed_signup').hide();
            var now = new Date();
        ...
        getAjaxSubmitUrl: function() {
            var url = document.querySelector("form#mc-embedded-subscribe-form").attr("action");
        ...
        getGroups: function() {
            var groups = {};
            document.querySelector(".mc-field-group").each(function(index) {
                var inputs = document.querySelector(this).querySelector("input:text:not(:hidden), input:checkbox:not(:hidden)");
                if (inputs.length > 1) {
        ...
        isMultiPartField: function(element) {
            return (document.querySelector('input:not(:hidden)', document.querySelector(element).closest(".mc-field-group")).length > 1);
        },
        /**
        ...
        isTooEarly: function(element) {
            var fields = document.querySelector('input:not(:hidden)', document.querySelector(element).closest(".mc-field-group"));
            return (document.querySelector(fields).eq(-1).attr('id') != document.querySelector(element).attr('id'));
        },
        /**
        ...
        mce_success_cb: function(resp) {
            ...
            document.querySelector('#mce-success-response').hide();
            document.querySelector('#mce-error-response').hide();

            // On successful form submission, display a success message and reset the form
            if (resp.result == "success") {
                document.querySelector('#mce-' + resp.result + '-response').show();
                document.querySelector('#mce-' + resp.result + '-response').html(resp.msg);
                document.querySelector('#mc-embedded-subscribe-form').each(function() {
                    this.reset();
                });
                ...
                try {
                    ...
                    if (index == -1) {
                        document.querySelector('#mce-' + resp.result + '-response').show();
                        document.querySelector('#mce-' + resp.result + '-response').html(msg);

                    } else {
                        var fieldName = document.querySelector("input[name*='" + fnames[index] + "']").attr('name'); // Make sure this exists (they haven't deleted the fnames array lookup)
                        var data = {};
                        data[fieldName] = msg;
    ...
    window.mc.mce_validator = document.querySelector("#mc-embedded-subscribe-form").validate({
        ...
        onfocusout: function(element) {
            if (!mc.isTooEarly(element)) {
                document.querySelector(element).valid();
            }
        },
        ...
        errorPlacement: function(error, element) {
            element.closest('.mc-field-group').insertAdjacentHTML("beforeend",error);
        },
        // Submit the form via ajax (see: jQuery Form plugin)
        submitHandler: function(form) {
            document.querySelector(form).ajaxSubmit(mc.ajaxOptions);
        }
    });
    ...
    // Evil Popup
    document.querySelector('#mc_embed_signup a.mc_embed_close').click(function() {
        mc.closePopup();
    });
