...
export async function convertClick(song, streamUrl) {
  ...
  // If they haven't clicked today or if this is their first click
  if (!lastClicked || new Date(lastClicked) < currentDate) {
    // Update last clicked date to now
